...
user1 = User(username= 'Framee17', password = "r4joferigroe", email = "mm@kmitl.ac.th", phone_number = "0626250119", full_name = "Natdanai Sangpho")
...
User.users[user._username] = user
User.users[user1._username] = user1

print(User.login("boomoioi", "maibok"))  
print(User.login("framee17", "r4joferigroe"))  
